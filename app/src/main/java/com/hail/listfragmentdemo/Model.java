...
public class Model {
	...
	public static final int[] iconList = { R.mipmap.tejia,
			R.mipmap.nvzhuang, R.mipmap.nanzhuang, R.mipmap.neiyi,
			R.mipmap.tongzhuang, R.mipmap.dianqi, R.mipmap.shouji,
			R.mipmap.diannao, R.mipmap.huazhuang, R.mipmap.muying,
			R.mipmap.meishi, R.mipmap.haixian, R.mipmap.jiaju,
			R.mipmap.jiaju, R.mipmap.nvxie, R.mipmap.nanzhuang,
			R.mipmap.shuji, R.mipmap.wanju, R.mipmap.zhongbiao,
			R.mipmap.shouji, R.mipmap.shipin, R.mipmap.yingshi,
			R.mipmap.muying, R.mipmap.qingqu, R.mipmap.haixian,
			R.mipmap.shechipin, R.mipmap.jiaju, R.mipmap.lvxing };
